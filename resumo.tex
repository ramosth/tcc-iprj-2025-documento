...
avaliação de risco integrado, desenvolvido pela autora, calcula um
fator de risco por meio da soma ponderada de sete variáveis que
...
temporais, previsão pluviométrica e pressão atmosférica ---, com os
limiares pluviométricos calibrados a partir de \citeonline{rico2008mine} 
e dos critérios do Sistema Alerta Rio \cite{sistemaalertario2025}, e mecanismo de
amplificação ativado em situações de saturação elevada concomitante a
previsão de chuva. A plataforma de \textit{software}
