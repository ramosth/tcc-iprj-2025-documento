...
\begin{figure}[!htb]
    \centering
    \fbox{\includegraphics[width=\textwidth]{figures/image18_metodo_etapa_unica.png}}
...
\begin{figure}[!htb]
    \centering
    \fbox{\includegraphics[width=0.95\textwidth]{figures/image21_distribuicao_barragens_por_metodo_atual.png}}
...
\begin{figure}[htbp]
    \centering
    \fbox{\includegraphics[width=0.97\textwidth]{figures/image26_classificacao_barragens.png}}
...
A soma das três dimensões define a faixa de classificação da CRI: Alta (pontuação total maior ou igual a 65, ou pontuação máxima em qualquer critério isolado de EC), Média (entre 38 e 64 pontos) e Baixa (até 37 pontos) \cite{brasil2017portaria70389}.

\begin{figure}[htbp]
    \centering
    \fbox{\includegraphics[width=0.97\textwidth]{figures/image27_classificacao_cri.png}}
...
A soma desses quatro critérios define a faixa de DPA: Alto (13 pontos ou mais), Médio (entre 8 e 12 pontos) e Baixo (até 7 pontos) \cite{brasil2017portaria70389}.

\begin{figure}[htbp]
    \centering
    \fbox{\includegraphics[width=0.97\textwidth]{figures/image27_classificacao_dpa.png}}
...
\begin{figure}[htbp]
    \centering
    \fbox{\includegraphics[width=0.8\textwidth]{figures/image27_classificacao_categoria_risco_dpa.png}}
...
A estrutura havia sido construída em 1976 pela Ferteco Mineração, adquirida pela Vale em 2001 e ampliada em múltiplas etapas por diferentes projetistas, também pelo método a montante \cite{wikipedia2019brumadinho}. Encontrava-se inativa desde 2015, classificada pela própria Vale como de ``baixo risco e alto potencial de danos'' \cite{wikipedia2019brumadinho}.

O acidente causou 272 mortes oficiais, tornando-se o maior acidente de trabalho em perda de vidas no Brasil, e liberou aproximadamente 12,7 milhões de metros cúbicos de rejeitos, que atingiram o ribeirão Ferro-Carvão e o rio Paraopeba, comprometendo o abastecimento de água e a biodiversidade aquática da região \cite{wikipedia2019brumadinho, minasgerais2024historico}.
