...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=\textwidth]{figures/cap5_arquitetura_sistema.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[angle=90, width=\textwidth]{figures/cap5_prototipo_hardware_pt1.jpeg}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=\textwidth]{figures/cap5_prototipo_hardware_pt2.jpeg}}
...
visualmente a integridade de todos os indicadores antes da operação. Ao concluir o teste de
\textit{hardware}, o sistema conecta ao Wi-Fi, sincroniza o horário via
NTP, consulta as APIs externas BNDMET e OWM, conforme mostra a
\autoref{fig:serial_inicializacao_pt1}. Por
fim, realiza a primeira coleta de dados, conforme registrado nas \autoref{fig:serial_inicializacao_pt2} a \autoref{fig:serial_inicializacao_pt4}, 
e declara operacional com a mensagem ``SISTEMA TOTALMENTE INICIADO'', conforme mostra a
\autoref{fig:serial_inicializacao_pt5}.

\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=\textwidth]{figures/cap5_serial_inicializacao_pt1.png}}
    \caption{Monitor serial durante a inicialização (parte~1): banner de
    identificação do sistema, leitura dos valores de calibração da EEPROM
    para solo seco e solo saturado, teste sequencial dos três LEDs indicadores; conexão
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=\textwidth]{figures/cap5_serial_inicializacao_pt2.png}}
    \caption{Monitor serial durante a inicialização (parte~2): primeira
    coleta de dados realizada - parte 1.}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=\textwidth]{figures/cap5_serial_inicializacao_pt3.png}}
    \caption{Monitor serial durante a inicialização (parte~3): primeira
    coleta de dados realizada - parte 2.}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=\textwidth]{figures/cap5_serial_inicializacao_pt4.png}}
    \caption{Monitor serial durante a inicialização (parte~4): primeira
    coleta de dados realizada - parte 3.}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=\textwidth]{figures/cap5_serial_inicializacao_pt5.png}}
    \caption{Monitor serial durante a inicialização (parte~5): sistema declarado operacional com a mensagem
    ``SISTEMA TOTALMENTE INICIADO''.}
    \label{fig:serial_inicializacao_pt5}
    \fonte{Autora, 2026.}
\end{figure}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=\textwidth]{figures/cap5_serial_backend_inacessivel_pt1.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=\textwidth]{figures/cap5_serial_backend_inacessivel_pt2.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=\textwidth]{figures/cap5_serial_wifi_sem_conexao_pt1.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=\textwidth]{figures/cap5_serial_wifi_sem_conexao_pt2.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=\textwidth]{figures/cap5_serial_sensor.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.90\textwidth]{figures/cap5_leds_niveis.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=\textwidth]{figures/cap5_serial_sensor_falha_pt1.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=\textwidth]{figures/cap5_serial_sensor_falha_pt2.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=\textwidth]{figures/cap5_serial_modo_manual.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=\textwidth]{figures/cap5_serial_modo_manual_vermelho.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=\textwidth]{figures/cap5_serial_bndmet.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.95\textwidth]{figures/cap5_serial_owm.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=\textwidth]{figures/cap5_serial_debug_pt1.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=\textwidth]{figures/cap5_serial_debug_pt2.png}}
    \caption{Painel de análise de risco exibido pelo comando \texttt{debug}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=\textwidth]{figures/cap5_serial_amplificado.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=\textwidth]{figures/cap5_serial_bndmet_falha_pt1.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=\textwidth]{figures/cap5_serial_bndmet_falha_pt2.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=\textwidth]{figures/cap5_serial_ntp_pendente.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=\textwidth]{figures/cap5_serial_bndmet_qualidade_baixa_pt1.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=\textwidth]{figures/cap5_serial_bndmet_qualidade_baixa_pt2.png}}
...
A ausência de medições horárias I175 para o momento da consulta é tratada de forma silenciosa, como demonstram as \autoref{fig:serial_i175_sem_medicao_pt1} e \autoref{fig:serial_i175_sem_medicao_pt2}: o sistema assume precipitação atual zero sem interromper o ciclo, mantendo valores anteriores. Esta condição foi observada em período noturno durante os testes, sendo um evento de ocorrência irregular que não pôde ser reproduzido de forma controlada.

\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=\textwidth]{figures/cap5_serial_i175_sem_medicao_pt1.png}}
    \caption{Monitor serial com fenômeno I175 sem medições para o horário atual (parte~1): ausência de dados horários identificada pelo sistema e precipitação horária assumida como zero; mantendo valores anteriores.}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=\textwidth]{figures/cap5_serial_i175_sem_medicao_pt2.png}}
    \caption{Monitor serial com fenômeno I175 sem medições para o horário atual (parte~2): mantêm valores anteriores ao erro e demais variáveis do modelo calculadas normalmente.}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=\textwidth]{figures/cap5_serial_owm_falha_pt1.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=\textwidth]{figures/cap5_serial_owm_falha_pt2.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=\textwidth]{figures/cap5_serial_ruptura_confiabilidade_100_pt1.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=\textwidth]{figures/cap5_serial_ruptura_confiabilidade_100_pt2.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=\textwidth]{figures/cap5_serial_wifi_falha_envio.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=\textwidth]{figures/cap5_serial_backend_sem_resposta.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=\textwidth]{figures/cap5_serial_heap_critico.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=\textwidth]{figures/cap5_serial_ruptura.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=\textwidth]{figures/cap5_serial_cooldown.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=\textwidth]{figures/cap5_serial_comando_nao_reconhecido.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=\textwidth]{figures/cap5_serial_comando_teste_pt1.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=\textwidth]{figures/cap5_serial_comando_teste_pt2.png}}
    \caption{Monitor serial durante execução do comando \texttt{teste} (parte~2): verificação do sensor e BNDMET.}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=\textwidth]{figures/cap5_serial_comando_teste_pt3.png}}
    \caption{Monitor serial durante execução do comando \texttt{teste} (parte~3): verificação OWM.}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=\textwidth]{figures/cap5_serial_comando_teste_pt4.png}}
    ...
    \label{fig:serial_comando_teste_pt4}
    \fonte{Autora, 2026.}
\end{figure}

% =============================================================
\section{Validação em Ambiente de Emulação Virtual (Wokwi)}
\label{sec:wokwi-resultados}
% =============================================================

Complementarmente aos testes com o protótipo físico apresentados na
Seção~\ref{sec:embarcado}, o \textit{firmware} adaptado
(\texttt{sketch.ino}) foi executado no ambiente de emulação Wokwi,
conforme descrito na Seção~\ref{subsec:wokwi}, por meio da extensão
Wokwi para o Visual Studio Code. O objetivo desta etapa foi reproduzir
de forma controlada e repetível cenários que, com o sensor físico
FC-28 em solo real, dependeriam de condições difíceis de padronizar em
laboratório.

A \autoref{fig:wokwi_boot} apresenta o monitor serial durante a
inicialização do dispositivo virtual: conexão à rede
\texttt{Wokwi-GUEST}, sincronização NTP e primeira consulta às APIs
externas, replicando a sequência observada no protótipo físico
(\autoref{fig:serial_inicializacao_pt1}).

\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=\textwidth]{figures/cap5_wokwi_boot.png}}
    \caption{Monitor serial do ambiente Wokwi durante a inicialização:
    conexão à rede virtual, sincronização NTP e primeira coleta de dados.}
    \label{fig:wokwi_boot}
    \fonte{Autora, 2026.}
\end{figure}

A \autoref{fig:wokwi_apis} mostra as consultas às APIs BNDMET e
OpenWeatherMap realizadas a partir do ambiente simulado, confirmando
que o \textit{gateway} de rede virtual do Wokwi permite tráfego HTTPS
real para a internet, requisito que motivou a escolha desta plataforma
em detrimento do TinkerCad.

\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.95\textheight, height=\textwidth, keepaspectratio, angle=-90]{figures/cap5_wokwi_apis.png}}
    \caption{Consultas às APIs BNDMET/DECEA e OpenWeatherMap realizadas
    a partir do ambiente de emulação Wokwi via \textit{gateway} de
    rede virtual.}
    \label{fig:wokwi_apis}
    \fonte{Autora, 2026.}
\end{figure}

A principal vantagem observada no ambiente emulado foi o controle
direto sobre a variável de umidade do solo: o potenciômetro virtual,
diferentemente do sensor resistivo em solo real, permite ajustar o
valor do ADC de forma imediata e reprodutível. A
\autoref{fig:wokwi_potenciometro} ilustra esse ajuste, com o valor de
ADC e a umidade calculada refletidos em tempo real no monitor serial.

\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=\textwidth]{figures/cap5_wokwi_potenciometro.png}}
    \caption{Ajuste do potenciômetro virtual no simulador Wokwi, com o
    valor de ADC e a umidade calculada correspondente exibidos no
    monitor serial.}
    \label{fig:wokwi_potenciometro}
    \fonte{Autora, 2026.}
\end{figure}

Durante o período em que os testes de emulação foram conduzidos, não
houve ocorrência de chuva na região de referência, de modo que as
variáveis de precipitação retornadas pelas APIs BNDMET e
OpenWeatherMap ($V_{ch.atual}$, $V_{ch.histórica}$, $V_{ch.mensal}$ e
$V_{ch.futura}$ da Equação~\ref{eq:frisco}) permaneceram próximas de zero durante
toda a coleta. Nessa condição, o ajuste isolado do potenciômetro não
era suficiente para elevar o fator de risco integrado até as faixas
AMARELO e VERMELHO, uma vez que os componentes pluviométricos
respondem por parcela relevante do peso total da equação. Para
viabilizar a demonstração desses níveis sem depender da ocorrência
natural de precipitação, o \textit{firmware} foi ajustado com um modo
de teste acionado via comando serial (\texttt{chuva sintetica}), que
fixa os quatro componentes pluviométricos em valores de referência
(precip24h=40mm, precip7d=100mm, precip30d=200mm, previsao24h=10mm),
mantendo os demais componentes ($V_{lencol}$, $V_{taxa\_var}$ e
$V_{pressão}$) vinculados às leituras reais do potenciômetro e do
sensor OpenWeatherMap. A partir dessa condição fixa, a variação do
potenciômetro entre aproximadamente 13\% e 23\% de umidade escala
naturalmente o nível para AMARELO, valores a partir de 24\% a 29\% escalam
para VERMELHO (faixa em que a amplificação de 1,2× da
Seção~\ref{subsec:wokwi} passa a ser aplicada), e valores a partir de
30\% acionam a rotina de ruptura, descrita a seguir.

As \autoref{fig:wokwi_led_verde} e \autoref{fig:wokwi_led_amarelo}
apresentam, respectivamente, o nível VERDE (obtido com dados reais de
chuva, sem necessidade do modo sintético, já que a condição de solo
seco e ausência de precipitação por si só caracteriza segurança) e o
nível AMARELO (obtido com o modo de chuva sintética ativo, conforme
descrito acima).

\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.95\textheight, height=\textwidth, keepaspectratio, angle=-90]{figures/cap5_wokwi_led_verde.png}}
    \caption{Circuito simulado no Wokwi com LED verde aceso (nível
    VERDE, condição segura).}
    \label{fig:wokwi_led_verde}
    \fonte{Autora, 2026.}
\end{figure}

\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.95\textheight, height=\textwidth, keepaspectratio, angle=-90]{figures/cap5_wokwi_led_amarelo.png}}
    \caption{Circuito simulado no Wokwi com LED amarelo aceso (nível
    AMARELO, atenção).}
    \label{fig:wokwi_led_amarelo}
    \fonte{Autora, 2026.}
\end{figure}

A \autoref{fig:wokwi_led_vermelho} apresenta o nível VERMELHO crítico,
também obtido com o modo de chuva sintética ativo e o potenciômetro
ajustado acima do limiar de 24\% a 29\%. Neste estado, o sistema aciona o
LED vermelho e um alarme sonoro intermitente, cuja frequência de repique
aumenta conforme o índice de risco se aproxima de 100\% -- 1000ms de
intervalo entre bipes para índices moderados, chegando a 300ms para
índices acima de 90\%.

\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.95\textheight, height=\textwidth, keepaspectratio, angle=-90]{figures/cap5_wokwi_led_vermelho.png}}
    \caption{Circuito simulado no Wokwi com LED vermelho aceso e
    \textit{buzzer} ativo (nível VERMELHO, situação crítica).}
    \label{fig:wokwi_led_vermelho}
    \fonte{Autora, 2026.}
\end{figure}

Já a \autoref{fig:wokwi_led_vermelho_ruptura} apresenta o quarto
e último cenário: a condição de RUPTURA, disparada de forma
independente da Equação~\ref{eq:frisco} sempre que a umidade do solo atinge ou
supera o limiar de 30\%, definido na Tabela~\ref{tab:alertas}. Embora
o LED aceso seja visualmente idêntico ao do estado VERMELHO crítico,
o \textit{firmware} trata as duas condições de forma distinta: a
ruptura substitui o alarme intermitente por um tom contínuo fixo em
2400Hz e força o índice de risco para 100\%, refletindo a natureza de
emergência absoluta desse estado -- razão pela qual a evidência deste
cenário é apresentada a partir do monitor serial, onde a rotina de
\textit{override} de ruptura (\texttt{RUPTURA - UMIDADE ACIMA DO
LIMIAR!}) é explicitamente reportada.

\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=\textwidth]{figures/cap5_wokwi_led_vermelho_ruptura.png}}
    \caption{Monitor serial do ambiente Wokwi durante o acionamento da
    rotina de ruptura (umidade $\geq$ 30\%), distinta do estado
    VERMELHO crítico por seu tom sonoro contínuo e índice de risco
    forçado a 100\%.}
    \label{fig:wokwi_led_vermelho_ruptura}
    \fonte{Autora, 2026.}
\end{figure}

Por fim, a \autoref{fig:wokwi_envio_backend} confirma a integração
ponta a ponta a partir do ambiente virtual: o dispositivo emulado
envia seus dados ao mesmo \textit{backend} local utilizado pelo
protótipo físico, via \path{POST /api/sensor/dados}, e o registro
correspondente é persistido e exibido normalmente no \textit{dashboard}
--- validando que a lógica de cálculo de risco, a integração com as
APIs externas e a comunicação com o \textit{backend} funcionam de
forma equivalente independentemente do hardware (físico ou emulado)
que origina os dados.

\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=\textwidth]{figures/cap5_wokwi_envio_backend.png}}
    \caption{Envio bem-sucedido dos dados do dispositivo emulado ao
    \textit{backend} local, com persistência confirmada e leitura
    refletida no \textit{dashboard}.}
    \label{fig:wokwi_envio_backend}
    \fonte{Autora, 2026.}
\end{figure}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.95\textwidth]{figures/cap5_landing_page_pt1.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.95\textwidth]{figures/cap5_landing_page_pt2.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.75\textwidth]{figures/cap5_cadastro_modal_preenchido_pt1.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.75\textwidth]{figures/cap5_cadastro_modal_preenchido_pt2.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.75\textwidth]{figures/cap5_cadastro_email_duplicado.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.75\textwidth]{figures/cap5_cadastro_campos_vazios.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.75\textwidth]{figures/cap5_cadastro_campos_invalidos.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.75\textwidth]{figures/cap5_login.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.75\textwidth]{figures/cap5_login_erro_credenciais.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.75\textwidth]{figures/cap5_login_sessao_expirada_pt1.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.75\textwidth]{figures/cap5_login_sessao_expirada_pt2.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.75\textwidth]{figures/cap5_login_sessao_expirada_pt3.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.75\textwidth]{figures/cap5_logout_redirecionamento.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.75\textwidth]{figures/cap5_reset_solicitar_email_pt1.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.75\textwidth]{figures/cap5_reset_solicitar_email_pt2.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.75\textwidth]{figures/cap5_reset_usuario_basico_pt1.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.75\textwidth]{figures/cap5_reset_usuario_basico_pt2.png}}
    \caption{Tela de solicitação de recuperação de senha: resposta genérica exibida pelo sistema independente de o endereço existir ou não na base de dados.}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.75\textwidth]{figures/cap5_reset_email_recebido_pt1.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.75\textwidth]{figures/cap5_reset_email_recebido_pt2.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.75\textwidth]{figures/cap5_reset_formulario_valida_token.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.75\textwidth]{figures/cap5_reset_formulario_nova_senha_pt1.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.75\textwidth]{figures/cap5_reset_formulario_nova_senha_pt2.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.75\textwidth]{figures/cap5_reset_formulario_nova_senha_pt3.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.75\textwidth]{figures/cap5_reset_token_expirado.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.75\textwidth]{figures/cap5_reset_senha_padrao_invalido.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.95\textwidth]{figures/cap5_dashboard_verde.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.95\textwidth]{figures/cap5_dashboard_amarelo.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.95\textwidth]{figures/cap5_dashboard_vermelho.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.95\textwidth]{figures/cap5_dashboard_ruptura.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.95\textwidth]{figures/cap5_dashboard_grafico.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.95\textwidth]{figures/cap5_dashboard_grafico_inferior.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.95\textwidth]{figures/cap5_dashboard_degradado.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.95\textwidth]{figures/cap5_dashboard_indisponivel.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.95\textwidth]{figures/cap5_dashboard_kpis_zerados.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.95\textwidth]{figures/cap5_sensores_tabela_pt1.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.95\textwidth]{figures/cap5_sensores_tabela_pt2.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.95\textwidth]{figures/cap5_sensores_tabela_pt3.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.95\textwidth]{figures/cap5_sensores_tabela_pt4.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.95\textwidth]{figures/cap5_sensores_erro_carregamento.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.95\textwidth]{figures/cap5_sensores_periodo_fixo.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.95\textwidth]{figures/cap5_sensores_periodo_data.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.95\textwidth]{figures/cap5_sensores_filtro_datas_vazias.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.95\textwidth]{figures/cap5_sensores_filtro_datas_invalidas.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.95\textwidth]{figures/cap5_sensores_filtro_com_resultado_pt1.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.95\textwidth]{figures/cap5_sensores_filtro_com_resultado_pt2.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.95\textwidth]{figures/cap5_sensores_filtro_sem_resultado.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.95\textwidth]{figures/cap5_sensores_expandido_pt1.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.95\textwidth]{figures/cap5_sensores_expandido_pt2.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.95\textwidth]{figures/cap5_sensores_expandido_pt3.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.95\textwidth]{figures/cap5_sensores_expandido_pt4.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.95\textwidth]{figures/cap5_sensores_csv_pt1.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.95\textwidth]{figures/cap5_sensores_csv_pt2.png}}
    \caption{Arquivo CSV exportado pela tela de Sensores aberto no
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.95\textwidth]{figures/cap5_sensores_csv_pt3.png}}
    \caption{Arquivo CSV exportado pela tela de Sensores aberto no
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.95\textwidth]{figures/cap5_sensores_csv_desabilitado.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.95\textwidth]{figures/cap5_alertas_lista.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.95\textwidth]{figures/cap5_alertas_lista_vazia.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.80\textwidth]{figures/cap5_alertas_form_preenchido_notificar_pt1.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.80\textwidth]{figures/cap5_alertas_form_preenchido_notificar_pt2.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.95\textwidth]{figures/cap5_alertas_expandido_pt1.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.95\textwidth]{figures/cap5_alertas_expandido_pt2.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.95\textwidth]{figures/cap5_alertas_expandido_pt3.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.80\textwidth]{figures/cap5_alertas_formulario.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.80\textwidth]{figures/cap5_alertas_sucesso.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.80\textwidth]{figures/cap5_alertas_sem_destinatario.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.80\textwidth]{figures/cap5_alertas_entrega_parcial_pt1.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.80\textwidth]{figures/cap5_alertas_entrega_parcial_pt2.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.80\textwidth]{figures/cap5_email_recebido_pt1.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.80\textwidth]{figures/cap5_email_recebido_pt2.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.80\textwidth]{figures/cap5_email_recebido_pt3.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.80\textwidth]{figures/cap5_email_recebido_pt4.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.95\textwidth]{figures/cap5_email_recebido_pt5.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.80\textwidth]{figures/cap5_email_recebido_pt6.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.95\textwidth]{figures/cap5_alertas_log.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.95\textwidth]{figures/cap5_alertas_log_detalhe.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.95\textwidth]{figures/cap5_alertas_log_vazio.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.95\textwidth]{figures/cap5_relatorio_gerado_pt1.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.95\textwidth]{figures/cap5_relatorio_gerado_pt2.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.95\textwidth]{figures/cap5_relatorio_gerado_pt3.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.95\textwidth]{figures/cap5_relatorio_gerado_pt4.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.95\textwidth]{figures/cap5_relatorio_gerado_pt5.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.95\textwidth]{figures/cap5_relatorio_gerado_pt6.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.95\textwidth]{figures/cap5_relatorio_erros_validacao_pt1.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.95\textwidth]{figures/cap5_relatorio_erros_validacao_pt2.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.95\textwidth]{figures/cap5_relatorio_erros_validacao_pt3.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.95\textwidth]{figures/cap5_relatorio_csv_sucesso.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.95\textwidth]{figures/cap5_relatorio_csv_sem_dados.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.95\textwidth]{figures/cap5_relatorio_html_sucesso.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.95\textwidth]{figures/cap5_relatorio_html_pt1.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.95\textwidth]{figures/cap5_relatorio_html_pt2.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.95\textwidth]{figures/cap5_relatorio_html_pt3.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.95\textwidth]{figures/cap5_usuarios_basicos.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.95\textwidth]{figures/cap5_usuarios_filtro_sem_resultado.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.95\textwidth]{figures/cap5_usuarios_admins_sem_permissao.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=\textwidth]{figures/cap5_usuarios_inativos_modal.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.75\textwidth]{figures/cap5_usuario_form.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.75\textwidth]{figures/cap5_usuario_form_adm.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.75\textwidth]{figures/cap5_usuario_criacao_email_duplicado.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.75\textwidth]{figures/cap5_usuario_edicao_email_duplicado.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.75\textwidth]{figures/cap5_usuario_modal_desativacao_pt1.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.75\textwidth]{figures/cap5_usuario_modal_desativacao_pt2.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=\textwidth]{figures/cap5_usuario_reativacao_toast_pt1.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=\textwidth]{figures/cap5_usuario_reativacao_toast_pt2.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=\textwidth]{figures/cap5_usuario_reativacao_toast_pt3.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.95\textwidth]{figures/cap5_usuarios_csv_sucesso.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.95\textwidth]{figures/cap5_usuarios_csv_sem_dados.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.95\textwidth]{figures/cap5_usuarios_csv_erro_backend.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.95\textwidth]{figures/cap5_usuarios_admins.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.75\textwidth]{figures/cap5_admin_form_senha_invalida.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.75\textwidth]{figures/cap5_admin_form_email_duplicado.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.95\textwidth]{figures/cap5_admins_sem_permissao.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.95\textwidth]{figures/cap5_configuracoes.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.95\textwidth]{figures/cap5_configuracoes_edicao.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.95\textwidth]{figures/cap5_config_email_em_uso.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.95\textwidth]{figures/cap5_configuracoes_superadmin.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.95\textwidth]{figures/cap5_config_health_erro.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.75\textwidth]{figures/cap5_alterar_senha_modal_pt1.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.75\textwidth]{figures/cap5_alterar_senha_modal_pt2.png}}
...
\begin{figure}[H]
    \centering
    \fbox{\includegraphics[width=0.75\textwidth]{figures/cap5_alterar_senha_nova_invalida.png}}
...
\begin{figure}[H]
    ...
    \fbox{\includegraphics[width=0.75\textwidth]{figures/cap5_alterar_senha_atual_incorreta.png}}
